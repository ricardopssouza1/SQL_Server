CREATE PROCEDURE USP_Calendario (@AnoInicial int, @AnoFinal int)
...
/****************************************************************************
* Function......: [Sp_Calendario]                  Data: 2018-03-28         *
* Criado por....: RSouza                                                    *
...
*                                                                           *
* Forma de uso                                                              *
* -- EXEC USP_Calendario 2017,2018                                          *
****************************************************************************/

DECLARE @DiasDoAno AS Table (
        data varchar(20)
      , ano int
      , mes int
      , dia int
...
set @dataInicial = '01/01/' + CONVERT(VARCHAR(4),@AnoInicial)
set @dataFinal = '31/12/'+ CONVERT(VARCHAR(4),@AnoFinal)
